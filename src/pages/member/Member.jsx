...
import { getUserPaginate, apiUser,  getMemberStatus, baseUrl, getFileCsvMember, getFileExcelMember  } from '../../api/api';
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className="flex justify-between w-full">
        <div className="flex  items-center gap-3 border rounded-sm px-3">
          <input type="text" placeholder="Search..." value={searchQuery} onChange={handleSearchInputChange}  className="p-2 outline-none" />
        ...
        <Table>
            <TableHead sx={{backgroundColor:'#0000001b'}}>
              <TableRow >
                ...
                <StyledTableCell>Mobile Address</StyledTableCell>
      ...
      <TableRow>
        ...
        dataToDisplay.map((item, index) => (
         <TableRow key={index}>
            ...
            <StyledTableCell>{item.individual?.mobile_number ?? "---"}</StyledTableCell>
