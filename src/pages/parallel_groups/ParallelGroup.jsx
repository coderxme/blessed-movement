...
import { getParallelGroup, getFileCsvParallel, getFileExcelParallel, baseUrl } from "../../api/api";
...
const handleDeleteCancelled = () => {
  ...
  const handleOpenUpdateDialog = (selectedItemIndex) => {
              ...
              <TableRow key={index} style={{ cursor: "pointer" }}>
                  ...
                  <TableCell sx={{position:"sticky", right:0,  bgcolor:"#f5f5f5cd",}}>
                    ...
                    <button   className="btn_view_users" onClick={() => handleOpenDialog(item)}  >
                      ...
                      <button className="btn_update_users" onClick={() => handleOpenUpdateDialog(index)}>
                      <FaRegEdit />
                    </button>
